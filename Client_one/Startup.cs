...
[assembly: OwinStartup(typeof(Client_one.Startup))]
            ...
            app.UseOpenIdConnectAuthentication(new OpenIdConnectAuthenticationOptions()
            {
                ...
                Notifications = new OpenIdConnectAuthenticationNotifications()
                {
                    RedirectToIdentityProvider = n =>
                    {
                        ...
                        //    n.ProtocolMessage.RedirectUri = "https://bs.com/contact";
                        ...
                        else if (n.ProtocolMessage.RequestType == OpenIdConnectRequestType.Logout)
                        {
                         ...
                         //   n.ProtocolMessage.PostLogoutRedirectUri = "https://bs.com/";
                        }
